...
// else {
//     // If search query parameter is not set or empty, echo an error message without selectable text
//     echo "<tr><td colspan='5' style='user-select: none;'>Invalid search query.</td></tr>";
// }
...
function printTable($result)
{
    ...
    if ($result->num_rows > 0) {
        ...
        $output .= "<th style='user-select: none;'>Address</th>";
        $output .= "<th style='user-select: none;'>Phone</th>";
        $output .= "<th style='user-select: none;'>Date Added</th>";
        $output .= "</tr>";
        $output .= "</thead>";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $output .= "<td style='user-select: none;'>" . $row['address'] . "</td>";
            $output .= "<td style='user-select: none;'>" . $row['phone'] . "</td>";
            $output .= "<td style='user-select: none;'>" . $row['date'] . "</td>";
            $output .= "</tr>";
        }
        // Close the table body
        $output .= "</tbody>";
